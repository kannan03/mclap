...
export default function FilterConsulateDialog(props : any) {
    ...
    const fetchData = ()=>{
        if( appliedCaseFilters){
            let consulate = appliedCaseFilters;
            ...
            <div className="">
                            ...
                            <PopoverContent id="crime-date" className="text-xs text-black thin-scrollbar m-1 w-[230px] max-h-50 overflow-y-auto p-0">
                                <Calendar
                                    ...
                                    onChange={(e: any) => {
                                        ...
                                        setCiDateNotified(moment(dateObj).format("YYYY/MM/DD"))
                ...
                <div>
                    <Label className="text-[0.7rem] font-semibold text-gray-600"
                        ...
                        className='w-full md:w-[320px] text-xs disabled:border-0 disabled:px-0 disabled:opacity-100 disabled:py-0 disabled:cursor-text disabled:resize-none'
                        />
                ...
                <div>
                    ...
                    <Input
                        ...
                        value={ciNotifiedHow}
                        type="text"
                        className="w-full md:w-[320px] text-xs disabled:border-0 disabled:px-0 disabled:opacity-100 disabled:py-0 disabled:cursor-text"
                        disabled={userRoles.includes("VIEWER")}
                        placeholder={userRoles.includes("VIEWER") ? "-" : "Type here"}
                        onChange={(e) => {
                            ...
                            <Popover>
                                <PopoverTrigger asChild>
                                    <Button
                                        variant={"outline"}
                                        className={cn(
                                            "h-8 w-full md:w-[225px] justify-start text-left text-xs font-normal disabled:border-0 disabled:px-0 disabled:opacity-100 disabled:py-0 disabled:cursor-text",
                                ...
                                <PopoverContent id="visit-to-defendant" className="text-xs text-black thin-scrollbar m-1 w-full md:w-[230px] max-h-50 overflow-y-auto p-0">
                                    <Calendar
                                        defaultView="century"
                                        onChange={(e: any) => {
                                            let dateObj = new Date(e);
                                            ...
                                            setCiDateFirstVisit(moment(dateObj).format("YYYY/MM/DD"))
                                ...
                                <PopoverContent id="date" className="text-xs text-black thin-scrollbar m-1 w-[230px] max-h-50 overflow-y-auto p-0">
                                    <Calendar
                                        ...
                                        onChange={(e: any) => {
                                            ...
                                            setCiDateMetDefAtt(moment(dateObj).format("YYYY/MM/DD"))
                    ...
                    <div>
                        ...
                        <div>
                            <Popover>
                                ...
                                <PopoverContent id="Date" className="text-xs text-black thin-scrollbar m-1 w-full md:w-[230px] max-h-50 overflow-y-auto p-0">
                                    <Calendar
                                        defaultView="century"
                                        onChange={(e: any) => {
                                            let dateObj = new Date(e);
                                            ...
                                            setCiDateMet(moment(dateObj).format("YYYY/MM/DD"))
